...
import logging, time, tracemalloc
...
# PROFILE DECORATOR
class Profiler:
    """Context-manager profiler for runtime and peak RAM per pipeline stage."""
    ...
    def __call__(self, stage: str) -> "Profiler._Stage":
    ...
    class _Stage:
        ...
        def __enter__(self) -> "Profiler._Stage":
